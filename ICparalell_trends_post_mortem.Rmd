...
RelativeLikelihood(M2 to Mmin(MBIC))= exp(-0.5(changembic(M2 to Mmin(MBIC))))=BF2toMminmbic
...
SchwarzWeight=P(Mi\|Data)=BFmi/sum over all M(BFmi/mlowestbic).
